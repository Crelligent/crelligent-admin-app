            ...
            >
                ...
                <div className="bg-[#0A0A0A] border border-white/10 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <span className="text-xs font-mono text-white/20 uppercase tracking-widest">Manual Override</span>
                        <div className="h-[1px] flex-1 bg-white/5" />
                    </div>
                    ...
                    <form className="space-y-5" onSubmit={handleLogin}>
                        ...
                        <div>
                            <label className="block text-xs font-mono uppercase tracking-widest text-white/40 mb-2">Admin Identity</label>
                            <div className="relative">
                                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-white/20" />
                                <input 
                                    type="email" 
                                    placeholder="operator@crelligent.com"
                                    value={email}
                                    onChange={(e) => setEmail(e.target.value)}
                                    className="w-full bg-[#050505] border border-white/10 rounded-xl py-3 pl-11 pr-4 text-sm text-white placeholder-white/20 focus:outline-none focus:border-white/30 transition-colors"
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            <label className="block text-xs font-mono uppercase tracking-widest text-white/40 mb-2">Security Key</label>
                            <div className="relative">
                                ...
                                <input 
                                    ...
                                    className="w-full bg-[#050505] border border-white/10 rounded-xl py-3 pl-11 pr-4 text-sm text-white placeholder-white/20 focus:outline-none focus:border-white/30 transition-colors tracking-widest"
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <button 
                            type="submit" 
                            disabled={isLoading}
                            className="w-full flex items-center justify-center gap-2 bg-white text-black hover:bg-white/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors py-3.5 rounded-xl text-sm font-medium mt-6 group"
                        >
                            {isLoading ? (
                                <><Loader2 className="w-4 h-4 animate-spin text-black/50" /> Verifying Clearance...</>
                            ) : (
                ...
                <div className="mt-8 text-center">
                    <p className="text-xs text-white/30">
                        Unauthorized access attempts are monitored and prosecuted.<br/>
                        Internal use only.
                    </p>
                </div>
            </motion.div>
